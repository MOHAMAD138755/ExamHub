...
new #[Layout('layouts::auth')] class extends Component {
    ...
    {
        return [
            'email.email' => 'پست الکترونیک وارد شده اشتباه است',
            'email.required' => 'وارد کردن پست الکترونیک اجباری است',
        ];
    }
...
<div class="flex justify-center items-center flex-col overflow-hidden">
    ...
    <div class="w-auto h-[58%] border-0  rounded-lg lg:border lg:border-gray-200">
        ...
        <div class="flex justify-center items-center w-full">
            <form class="w-full px-10" wire:submit="login">

                <div class="relative w-full my-5 xl:w-full lg:w-[650px] md:w-[720px] sm:w-[610px]">
                    <input wire:model.live.blur="email" @class(["peer border-gray-300 border rounded-sm w-full h-11 px-4 text-sm
                    outline-none transition-all focus:border-blue-500",'border-red-500' => $errors->has('email')]) type="text"
                           placeholder=" ">
        ...
        <div class="w-full flex my-5 mx-5 md:mx-10">
            <button x-on:click="dark=!dark" class="w-[120px] h-[35px] bg-blue-700 text-white rounded-lg mx-20
             cursor-pointer hover:bg-blue-950 transition-all">تغییر رنگ
            </button>
        </div>
